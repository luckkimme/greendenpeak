...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2022 at 10:09 AM
...
(1, NULL, '/asset/img/about-us/history.jpg', 1),
(2, NULL, '/asset/img/about-us/rainbow-cleaning-systems-logo-1.png', 1),
(3, NULL, '/asset/img/about-us/thermostar-logo.png', 1),
(4, NULL, '/asset/img/about-us/DCS LOGO - No Background.png', 1);
...
(1, 'Greendenpeak, OPC', '/asset/img/index/carousel/carousel-1.png', 1),
(2, 'Rainbow Vacuum Cleaner', '/asset/img/index/carousel/carousel-2.jpg', 1),
(3, 'Thermostar Dry Cleaner', '/asset/img/index/carousel/carousel-3.jpg', 1);
...
(1, 'The Power of Water', 'The Rainbow Cleaning System cleans your home the most natural way possible, using The Power of Water', '/asset/img/products/rainbow/Rainbow_SRX-animation.gif', 1, 1);
...
(1, '1. Wet Dust Can\'t Fly', 'The Rainbow uses Mother Nature’s most powerful element, water, to trap dirt and odors, returning only naturally clean, water-washed air to your home environment.', '\\asset\\img\\products\\rainbow\\rainbow-srx-churn.jpg', 1, 1),
(2, '2. TWICE AS CLEAN', 'This unique water filtration system captures typical household dirt, while remaining microscopic particles are caught by our HEPA Neutralizer Filtration System. This two-stage filtration combination removes nearly 100% of dirt and contaminants from your home.', '\\asset\\img\\products\\rainbow\\rainbow-srx-churn.jpg', 1, 1),
(3, '3. HURRICANE® MOTOR', 'Powered by switched-reluctance technology, our powerful Hurricane® motor has the force to tackle your toughest cleaning jobs and offers indefinite motor life.', '\\asset\\img\\products\\rainbow\\rainbow-srx-churn.jpg', 1, 1),
(4, '4. POWER AND CONTROL AT YOUR FINGERTIPS', 'We’ve thoughtfully placed the controls in an ergonomic handle grip, allowing precise control over powered accessories.  ', '\\asset\\img\\products\\rainbow\\rainbow-srx-churn.jpg', 1, 1),
(5, '5. QUICK CONNECT', 'Changing wands and tools for different jobs is a snap.', '\\asset\\img\\products\\rainbow\\rainbow-srx-churn.jpg', 1, 1),
(6, '6. TRAVEL LIGHTLY', 'The Rainbow follows you from room-to-room on its easy-maneuvering dolly. A rubberized bumper protects your walls and furniture. ', '\\asset\\img\\products\\rainbow\\rainbow-srx-churn.jpg', 1, 1),
(7, '7. ON-BOARD LED HEADLIGHTS', 'Illuminates the path ahead, ensuring you’ll never miss a spot.  ', '\\asset\\img\\products\\rainbow\\rainbow-srx-churn.jpg', 1, 1),
(8, '8. WALL-TO-WALL CLEANING', 'Dirt, pet hair and crumbs vanish in the Power Nozzle’s powerful revolving brush.  ', '\\asset\\img\\products\\rainbow\\rainbow-srx-churn.jpg', 1, 1);
...
(1, 'sample', NULL, '/asset/img/products/rainbow/rainbow-srx-churn.jpg', 0, 1);
...
(1, 'AHAM VERIFIDE', 'The Association of Home Appliance Manufacturers(AHAM) certifies that the Rainbow is a proven air cleaner designed to reduce air pollutants that contribute to poor indoor air quality', NULL, '/asset/img/products/rainbow/other-info/aham-certification-1.png', NULL, 1, 1),
(2, 'CERTIFIED ASTHMA & ALLERGY FRIENDLY', 'The Rainbow is certified asthma & allergy friendly™ by the Asthma and Allergy Foundation of America.', NULL, '/asset/img/products/rainbow/other-info/certified-asthma-allergy-friendly-1.png', NULL, 1, 1),
(3, 'THE CARPET AND RUG INSTITUTE', 'The Rainbow has met the Carpet Industry Standard for all three elements: soil removal, dust containment and carpet appearance. ', NULL, '/asset/img/products/rainbow/other-info/', NULL, 1, 1),
(4, 'ANIMAL CAGES, METAL GRATES AND OTHER', NULL, NULL, '/asset/img/products/thermostar/application/1animals.png', NULL, 1, 2),
(5, 'BATHROOMS AND TOILETS', NULL, NULL, '/asset/img/products/thermostar/application/2bathrooms.png', NULL, 1, 2),
(6, 'BICYCLES AND MOTORCYCLES', NULL, NULL, '/asset/img/products/thermostar/application/3motorcycle.png', NULL, 1, 2),
(7, 'CAR EXTERIOR CLEANING', NULL, NULL, '/asset/img/products/thermostar/application/4car.png', NULL, 1, 2),
(8, 'CAR INTERIOR CLEANING', NULL, NULL, '/asset/img/products/thermostar/application/5interior.png', NULL, 1, 2),
(9, 'CARPET CLEANING', NULL, NULL, '/asset/img/products/thermostar/application/6carpet.png', NULL, 1, 2),
(10, 'CARPET AND FABRIC STAINS', NULL, NULL, '/asset/img/products/thermostar/application/7fabric.png', NULL, 1, 2),
(11, 'CLEANING BATHROOM FIXTURES AND REMOVING CALCIUM', NULL, NULL, '/asset/img/products/thermostar/application/8calcium.png', NULL, 1, 2),
(12, 'DRAIN CLEANING', NULL, NULL, '/asset/img/products/thermostar/application/9drain.png', NULL, 1, 2),
(13, 'CLEAN WINDOW FRAMES', NULL, NULL, '/asset/img/products/thermostar/application/10window.png', NULL, 1, 2),
(14, 'CLEANING YOUR OVEN', NULL, NULL, '/asset/img/products/thermostar/application/11oven.png', NULL, 1, 2),
(15, 'DEFROST AND REMOVE THE ICE FROM THE FREEZER', NULL, NULL, '/asset/img/products/thermostar/application/12freezer.png', NULL, 1, 2),
(16, 'JOINTS/GROOVES', NULL, NULL, '/asset/img/products/thermostar/application/13joints.png', NULL, 1, 2),
(17, 'KITCHEN GREASE', NULL, NULL, '/asset/img/products/thermostar/application/14kitchen.png', NULL, 1, 2),
(18, 'LEATHER', NULL, NULL, '/asset/img/products/thermostar/application/15leather.png', NULL, 1, 2),
(19, 'MATTRESSES AND UPHOLSTERY', NULL, NULL, '/asset/img/products/thermostar/application/16mattress.png', NULL, 1, 2),
(20, 'PVC AND FLOOR TILES', NULL, NULL, '/asset/img/products/thermostar/application/17tiles.png', NULL, 1, 2),
(21, 'PARQUET AND LAMINATE FLOORING', NULL, NULL, '/asset/img/products/thermostar/application/18flooring.png', NULL, 1, 2),
(22, 'POLISHED WOOD SURFACES', NULL, NULL, '/asset/img/products/thermostar/application/19wood.png', NULL, 1, 2),
(23, 'RADIATORS', NULL, NULL, '/asset/img/products/thermostar/application/20radiator.png', NULL, 1, 2),
(24, 'VENETIAN BLINDS', NULL, NULL, '/asset/img/products/thermostar/application/21blinds.png', NULL, 1, 2),
(25, 'WALL TILES AND SHOWER STALLS', NULL, NULL, '/asset/img/products/thermostar/application/22stalls.png', NULL, 1, 2),
...
(1, 'Rainbow SRX - Manual', '/asset/download/Rainbow-SRX-Manual.pdf', 1),
(2, 'Rainbow e2 (Black) Manual', '/asset/download/Rainbow-e2-(Black)-Manual.pdf', 1),
(3, 'Rainbow e2 (Silver) Manual', '/asset/download/Rainbow-e2-(Silver)-Manual.pdf', 1),
(4, 'Rainbow e2 (Gold) Manual', '/asset/download/Rainbow-e2-(Gold).pdf', 1),
(5, 'Thermostar User Guide (pdf)', '/asset/download/thermostar-users-guide.pdf', 2),
(6, 'Steam Iron User Manual (pdf)', '/asset/download/Steamiron_usermanual_englisch.pdf', 2),
(7, 'Steam Iron Station User Manual (pdf)', '/asset/download/Steamironstation_usermanual_englisch.pdf', 2);
