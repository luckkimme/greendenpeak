<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light" aria-label="Main navigation" id="nav-main">
    <div class="container-fluid">
        <a class="navbar-brand navbar-brand-main" href="index.php">
            <img src="<?php echo $company['company_logo']; ?>" alt="Logo" class="d-inline-block">
        ...
        <div class="navbar-collapse offcanvas-collapse div-navbar-offcanvas">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="page/about-us.php" id="nav-about">about us</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="page/contact-us.php" id="nav-contact">contact us</a>
                </li>
            </ul>
        </div>
    </div>
